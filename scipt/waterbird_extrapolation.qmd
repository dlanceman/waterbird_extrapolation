...
Stats2025 <- matrix(c(AreaPropString("Overall wetland", inun_2025, cumbung_noBac, cumbung_noBac),
                      AreaPropString("Transect 1", inun_2025, cumbung_noBac, trk_2025_buff[6,]),
                      AreaPropString("Transect 2", inun_2025, cumbung_noBac, trk_2025_buff[1,]),
                      AreaPropString("Transect 3", inun_2025, cumbung_noBac, trk_2025_buff[2,]),
                      AreaPropString("Transect 4", inun_2025, cumbung_noBac, trk_2025_buff[3,]),
                      AreaPropString("Transect 5", inun_2025, cumbung_noBac, trk_2025_buff[4,]),
                      AreaPropString("Transect 6", inun_2025, cumbung_noBac, trk_2025_buff[5,])),
               ncol = 3, byrow = TRUE)
