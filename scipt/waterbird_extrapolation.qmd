...
-   clip and buffer tracklogs (**This section onwards needs to be updated for all years other than 2024**)
    ...
    -   for cases where they are merged, separate the tracklogs from different dates and/or counts
...
plot(inun_2011)
plot(trk_2011_C1_buff, add = TRUE)
plot(trk_2011_C2_buff, add = TRUE)
...
plot(inun_2014)
plot(trk_2014_C1_buff, add = TRUE)
plot(trk_2014_C2_buff, add = TRUE)
...
plot(inun_2017)
plot(trk_2017_main_C1_buff, add = TRUE)
plot(trk_2017_main_C2_buff, add = TRUE)
...
# I think this was extra working stuff that can be deleted
  y <- inun_2020 %>% 
  crop(extent(cumbung_noBac)) %>% 
  mask(cumbung_noBac) %>% 
  mask(trk_2020_main_C1_buff[1,]) # clip the inundation raster to the cumbung boundary
  plot(y)
  
  g <- as.data.frame(freq(y)) %>% subset(value == 1)
  g$area <- g$count # calculate no. cells inundated within the cumbung boundary
  
  a <- round(st_area(trk_2020_main_C1_buff[1,])/10000)
  
  p <- round(as.numeric(g$area*30*30/st_area(trk_2020_main_C1_buff[1,]) * 100),2)
...
Stats2010 <- matrix(c(AreaPropString("Overall wetland", inun_2010, cumbung_eco, cumbung_eco),
                      ...
                      AreaPropString("Cumbung Transect 3", inun_2010, cumbung_eco, trk_2010_buff[6,]),
                      AreaPropString("Cumbung Transect 4", inun_2010, cumbung_eco, trk_2010_buff[7,]),
                      AreaPropString("Cumbung Transect 5", inun_2010, cumbung_eco, trk_2010_buff[4,]),
                      AreaPropString("Cumbung Transect 6", inun_2010, cumbung_eco, trk_2010_buff[5,]),
                      AreaPropString("Cumbung Transect 7", inun_2010, cumbung_eco, trk_2010_buff[3,]),
...
Stats2011 <- matrix(c(AreaPropString("Overall wetland", inun_2011, cumbung_noMarool, cumbung_noMarool),
                      AreaPropString("Cumbung Swamp Count 1", inun_2011, cumbung_noMarool, trk_2011_C1_buff[5,]),
                      AreaPropString("Lachlan River Count 1", inun_2011, cumbung_noMarool, trk_2011_C1_buff[4,]),
                      AreaPropString("Cumbung A6 Count 1", inun_2011, cumbung_noMarool, trk_2011_C1_buff[3,]),
                      AreaPropString("Cumbung A7 Count 1", inun_2011, cumbung_noMarool, trk_2011_C1_buff[2,]),
                      AreaPropString("Cumbung A8 Count 1", inun_2011, cumbung_noMarool, trk_2011_C1_buff[1,]),
                      AreaPropString("Cumbung Swamp Count 2", inun_2011, cumbung_noMarool, trk_2011_C2_buff[5,]),
                      AreaPropString("Lachlan River Count 2", inun_2011, cumbung_noMarool, trk_2011_C2_buff[4,]),
                      AreaPropString("Cumbung A6 Count 2", inun_2011, cumbung_noMarool, trk_2011_C2_buff[3,]),
                      AreaPropString("Cumbung A7 Count 2", inun_2011, cumbung_noMarool, trk_2011_C2_buff[2,]),
                      AreaPropString("Cumbung A8 Count 2", inun_2011, cumbung_noMarool, trk_2011_C2_buff[1,])),
               ncol = 3, byrow = TRUE)
...
# 2014
Stats2014 <- matrix(c(AreaPropString("Overall wetland", inun_2014, cumbung_eco, cumbung_eco),
                      AreaPropString("Cumbung Swamp Count 1", inun_2014, cumbung_eco, trk_2014_C1_buff),
                      AreaPropString("Cumbung Swamp Count 2", inun_2014, cumbung_eco, trk_2014_C2_buff)),
               ncol = 3, byrow = TRUE)
...
Stats2015 <- matrix(c(AreaPropString("Overall wetland", inun_2015, cumbung_noBac_noM, cumbung_noBac_noM),
                      ...
                      AreaPropString("Cumbung S Count 2", inun_2015, cumbung_noBac_noM, trk_2015_main_C1_buff[1,]),
                      AreaPropString("Cumbung Swamp Count 2", inun_2015, cumbung_noBac_noM, trk_2015_main_C1_buff[3,]),
                      AreaPropString("Cumbung B Count 2", inun_2015, cumbung_noBac_noM, trk_2015_main_C1_buff[4,]),
                      AreaPropString("Cumbung AA Count 2", inun_2015, cumbung_noBac_noM, trk_2015_main_C1_buff[2,])),
               ncol = 3, byrow = TRUE)
...
Stats2017 <- matrix(c(AreaPropString("Overall wetland", inun_2017, cumbung_noBac, cumbung_noBac),
                      ...
                      AreaPropString("Cumbung 1 Count 1", inun_2017, cumbung_noBac, trk_2017_main_C1_buff[1,]),
                      AreaPropString("Lignum Lake (not) Count 1", inun_2017, cumbung_noBac, trk_2017_main_C1_buff[2,]),
                      AreaPropString("Cumbung 3 Count 1", inun_2017, cumbung_noBac, trk_2017_main_C1_buff[3,]),
                      AreaPropString("Cumbung 1 Count 2", inun_2017, cumbung_noBac, trk_2017_main_C2_buff[1,]),
                      AreaPropString("Cumbung 3 Count 2", inun_2017, cumbung_noBac, trk_2017_main_C2_buff[2,])),
               ncol = 3, byrow = TRUE)
...
Stats2020 <- matrix(c(AreaPropString10("Overall wetland", inun_2020, cumbung_noBac, cumbung_noBac),
                      ...
                      AreaPropString10("Baconian Swamp Count 1", inun_2020, Baconian, trk_2020_Bac_C1_buff),
                      AreaPropString10("Baconian Swamp Count 2", inun_2020, Baconian, trk_2020_Bac_C2_buff),
                      AreaPropString10("Cumbung E1 Count 1", inun_2020, cumbung_noBac, trk_2020_main_C1_buff[1,]),
                      AreaPropString10("Lower Lachlan 3 Count 1", inun_2020, Baconian, trk_2020_main_C1_buff[2,]),
                      AreaPropString10("Cumbung 2 Count 1", inun_2020, cumbung_noBac, trk_2020_main_C1_buff[3,]),
                      AreaPropString10("Lachlan L1 Count 1", inun_2020, cumbung_noBac, trk_2020_main_C1_buff[4,]),
                      AreaPropString10("Cumbung 3 Count 1", inun_2020, cumbung_noBac, trk_2020_main_C1_buff[5,]),
                      AreaPropString10("Cumbung E1 Count 2", inun_2020, cumbung_noBac, trk_2020_main_C2_buff[1,]),
                      AreaPropString10("Lower Lachlan 3 Count 2", inun_2020, Baconian, trk_2020_main_C2_buff[3,]),
                      AreaPropString10("Cumbung 2 Count 2", inun_2020, cumbung_noBac, trk_2020_main_C2_buff[5,]),
                      AreaPropString10("Lachlan L1 Count 2", inun_2020, cumbung_noBac, trk_2020_main_C2_buff[2,]),
                      AreaPropString10("Cumbung 3 Count 2", inun_2020, cumbung_noBac, trk_2020_main_C2_buff[4,])),
               ncol = 3, byrow = TRUE)
...
# 2011
Prop2011C1 <- inun_prop_surveyed("2011", "Cumbung Swamp", "1", inun_2011, trk_2011_C1_buff, cumbung_noMarool)
Prop2011C2 <- inun_prop_surveyed("2011", "Cumbung Swamp", "2", inun_2011, trk_2011_C2_buff, cumbung_noMarool)
...
# 2014
Prop2014C1 <- inun_prop_surveyed("2014", "Cumbung Swamp", "1", inun_2014, trk_2014_C1_buff, cumbung_eco)
Prop2014C2 <- inun_prop_surveyed("2014", "Cumbung Swamp", "2", inun_2014, trk_2014_C2_buff, cumbung_eco)
...
Prop2017C1 <- inun_prop_surveyed("2017", "Cumbung Swamp", "1", inun_2017, trk_2017_main_C1_buff, cumbung_noBac)
Prop2017C2 <- inun_prop_surveyed("2017", "Cumbung Swamp", "2", inun_2017, trk_2017_main_C2_buff, cumbung_noBac)
