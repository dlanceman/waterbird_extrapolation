...
Note, I haven't done this for every year so the other years are still in a non-arranged order and hence I've called haphazard numbers in the steps below. But I recommend you do this for all your buffered tracklogs! If you have more than 9 transects, you will still have to go into the transect file and check what row each of them are assigned for the below steps, as it will usually organise 10 after 1 and 2 rather than after 9.
...
# the [1,] etc in brackets indicates what row that transect is located in.
